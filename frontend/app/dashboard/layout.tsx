      ...
      <div className="min-w-0 flex-1">
        <header className="border-b border-slate-200/80 bg-white/90 backdrop-blur">
          <div className="flex min-h-[84px] items-center justify-between gap-4 px-5 sm:px-8 lg:px-10">
            ...
            <div className="flex items-center gap-3"><button aria-label="Notifications" className="relative rounded-xl p-2.5 text-slate-500 transition hover:bg-slate-100 hover:text-slate-800"><Icon name="bell" size={19} /><span className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-red-500" /></button><Button variant="secondary" onClick={() => void logout()} className="px-3 py-2 text-xs"><Icon name="logout" size={15} /><span className="hidden sm:inline">Sign out</span></Button></div>
          </div>
